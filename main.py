...
label_voluntary_preference = tk.Label(root, text="Preferencje wolontariackie:")
label_voluntary_preference.grid(row=11, column=0, padx=10, pady=5, sticky="w")
entry_voluntary_preference = tk.Entry(root, width=40)
entry_voluntary_preference.grid(row=11, column=1, padx=10, pady=5)
